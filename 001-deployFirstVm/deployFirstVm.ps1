...
Write-Host "Querying the IP Info API"
$apiResponse = Invoke-WebRequest -Uri https://ipinfo.io | ConvertFrom-Json

Write-Host "Parsing your public IP address from the API response"
$yourPublicIp = $apiResponse.ip
